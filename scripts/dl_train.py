...
def run_keras_gridsearch() -> Dict[str, Dict[str, Any]]:
    ...
    Returns:
        Dictionary holding instance of the model and score for each trained model.
    """
    pass
...
def run_ensemble(best_models: Dict[str, Dict[str, Any]]) -> VotingClassifier:
    ...
    Args:
        best_models: A dict where keys are model names and values are dicts containing 'model' and 'score'.

    Returns:
        A trained VotingClassifier instance.
    """
    pass
