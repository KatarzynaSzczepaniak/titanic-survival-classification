...
"""
Script description:
This script prepares data for ML/DL pipeline by scaling and encoding the features, and splitting the data into train/val/test sets.
...
def transform_data(
    ...
    Args:
        ...
        drop_cols (optional): List of columns to drop from features (e.g., 'Name', 'Ticket').
        random_state (optional): Seed for train/validation split.
